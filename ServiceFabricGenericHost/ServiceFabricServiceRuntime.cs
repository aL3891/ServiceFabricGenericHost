...
namespace ServiceFabricGenericHost
{
    internal class ServiceFabricServiceRuntime : IServiceFabricRuntime
    {
        ...
        public ServiceFabricServiceRuntime()
        {
        ...
        public NodeContext GetNodeContext() => FabricRuntime.GetNodeContext();
        public ICodePackageActivationContext GetActivationContext() => FabricRuntime.GetActivationContext();
    }
}
